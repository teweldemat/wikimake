---
title: "Tasks: Make a Copper Awl (Metal Tool)"
...
- [x] Add a target geometry table (length, tip angle, shaft diameter by use-case).
- [x] Add a maintenance/repair subsection.
- [x] Add expected lifetime and failure mode notes.
