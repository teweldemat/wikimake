---
title: "Make Green-Wood Tongs"
slug: "make-green-wood-tongs"
summary: "Bend a freshly cut stick into spring tongs for handling hot pottery, hot metal, coals, and hot stones."
order: 5
tech_level: 1
prereqs:
...
- A cutting/scraping edge: [Make a Stone Flake Cutting Edge](/articles/make-stone-flake-cutting-edge)

## Diagram

![Green-wood tongs: thin the middle, bend in half, grip](/diagrams/tools/green-wood-tongs.svg)
...
Tie a snug band of cordage around both arms a palm-width below the bend — a few tight wraps finished with two half-hitches ([Tie Basic Knots](/articles/tie-basic-knots)). It stops the bend from opening flat and makes the spring stiffer.
