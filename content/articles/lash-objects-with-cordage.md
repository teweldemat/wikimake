---
title: "Lash Objects Together (Cordage)"
slug: "lash-objects-with-cordage"
summary: "Bind objects with tight cordage wraps that hold by friction, and lock the wraps so they cannot slip."
order: 2
tech_level: 2
prereqs:
...
- **Standing part / working end / half-hitch** — see [Tie Basic Knots](/articles/tie-basic-knots).

## Prerequisites

- Cordage: [Make Cordage (Plant Fibers)](/articles/make-cordage-plant-fibers)
- Knots for starting and locking the lashing: [Tie Basic Knots](/articles/tie-basic-knots)

## Diagram

![Lashing sequence: anchor and wrap, keep tension, lock and test](/diagrams/cordage/lashing-sequence.svg)
...
1. Finish with two locking half-hitches around the standing part or around the bound object (see [Tie Basic Knots](/articles/tie-basic-knots)).
